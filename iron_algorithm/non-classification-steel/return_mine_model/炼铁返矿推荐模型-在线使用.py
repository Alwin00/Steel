...
def BOF_LTFK_CACL(data):
    ...
    LTFK_Fe2O3 = 71.6  # 炼铁返矿中Fe2O3含量
    LTFK_FeO = 7.31  # 炼铁返矿中FeO含量
    ...
    #炉气物理热
    Gas_Physical_Heat = (
        (Weight_Iron * Arrival_C + Weight_FG + FG_C + Weight_ZCST * ZCST_C - (Weight_Iron + Weight_FG + Weight_ZCST) *0.87 * End_C)/100
