...
def cal_O2(name, mean, scale):
    ...
    X_test = data1[predict_T].values
    y_test = data1[y_T].values
    # 输入数据标准化
    ...
    hit_rate1, hit_rate2, hit_rate3, MAE = hitrate(y_test, answer, level1=8, level2=10, level3=15)
    print(name[0:-5]+'终点温度预测命中率:', hit_rate1, hit_rate2, hit_rate3, MAE)
